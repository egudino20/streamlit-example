...
def load_season_match_team_dfs(matches_data, league_folder, season):
    ...
    for club in clubs:
        ...
        club_df = pd.read_csv(f"Data/{league_folder}/{season}/team-files/{club}-{season}.csv")
...
def generate_match_week_zone_control_viz(team_dataframes, match_week, league, comp, season, off_week=True):
    ...
    # Setup the pitch
    pitch = VerticalPitch(pitch_type='opta', pitch_color='#333d5b', line_color='w', line_zorder=5,
